...
import MediaFeatureAudioObj from '../objects/MediaFeatureVideoObj.jsx'
  ...
  render() {
    return (
      <div className="o-mediafile--video">
        ...
        <MediaModalComp showModal={this.state.showModal} handleCloseModal={this.handleCloseModal} heading="New Horizons Kuiper Belt Fly-through">
