    ...
    return (
      <div>
        ...
        <section className="o-columnbox__main">
          <header>
            <h2 className="o-columnbox__main-heading">About eScholarship</h2>
          </header>
        ...
        <section className="o-columnbox__sidebar">
          <header>
            <h2 className="o-columnbox__sidebar-heading">Placeholder Title</h2>
          </header>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias sed sapiente nulla debitis nobis asperiores hic est, fuga illo? Accusamus molestias pariatur nihil, libero possimus optio iusto nobis sapiente ad.
          </p>
        </section>
        <h2>Main Column Box Divided</h2>
        <section className="o-columnbox__main">
          <header>
            <h2 className="o-columnbox__main-heading">About eScholarship</h2>
          </header>
