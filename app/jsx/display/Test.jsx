    ...
    return (
      <div className="c-test">
        <details className="c-test__details">
          <summary className="c-test__summary">Main Content</summary>
        ...
        <details className="c-test__details">
          <summary className="c-test__summary">Supplemental material</summary>
          <div className="c-test__tabpanel">
        ...
        <details className="c-test__details">
          <summary className="c-test__summary">Metrics</summary>
          <div className="c-test__tabpanel">
        ...
        <details className="c-test__details">
          <summary className="c-test__summary">Author & Article Info</summary>
          <div className="c-test__tabpanel">
        ...
        <details className="c-test__details">
          <summary className="c-test__summary">Comments (2)</summary>
          <div className="c-test__tabpanel">
