...
class Test extends React.Component {
  componentDidMount() {
    $('.c-test').css('margin-bottom', $('.c-test__content').outerHeight());
  }
  render() {
    return (
      <div>
        <div className="c-test">
          <details className="c-test__details" open>
            <summary className="c-test__summary">This Is Tab Number 1 Here</summary>
          ...
          <details className="c-test__details">
            <summary className="c-test__summary">This Is Tab Number 2 Here</summary>
            <div className="c-test__content">
          ...
          <details className="c-test__details">
            <summary className="c-test__summary">This Is Tab Number 3 Here</summary>
            <div className="c-test__content">
