      ...
      <nav className="c-nav3">
        <details open={this.state.isOpen ? "open" : ""} className="c-nav3__main">
          ...
          <div className={this.state.submenuActive ? "c-nav3__main-items--submenu-active" : "c-nav3__main-items"}>
            ...
            <details className="c-nav3__sub" ref={(domNode)=> this.nav3__sub2 = domNode}>
              <summary className="c-nav3__sub-button" onClick = {(event)=> this.setState({submenuActive: !this.nav3__sub2.open})}>
                About
              </summary>
              <div className="c-nav3__sub-items">
                <button className="c-nav3__sub-items-button" aria-label="return to menu" onClick = {()=> { this.setState({submenuActive: false}); this.nav3__sub2.open = false; }}>Main Menu</button>
                <a href="">About Us</a>
                <a href="">Aims &amp; Scope</a>
