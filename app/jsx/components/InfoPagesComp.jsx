  ...
  render() {
    return (
      <div className="c-infopages">
        ...
        <div className="c-infopages__items" hidden={!this.state.showMore}>
          <div className="c-infopages__item">
            <h2>
              <a href="">The Center for Environmental Design Research</a>
              <a href="" className="c-infopages__title">In the Press</a>
        ...
        <button className="c-infopages__show" onClick={()=> this.setState({showMore: true})} hidden={this.state.showMore}>Show more informational page results</button>
        <button className="c-infopages__show" onClick={()=> this.setState({showMore: false})} hidden={!this.state.showMore}>Show less informational page results</button>
      </div>
    )
  }
}
