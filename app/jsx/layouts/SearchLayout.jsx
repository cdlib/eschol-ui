        ...
        <div className="c-columns">
          ...
          <main id="maincontent">
            ...
            <section className="o-columnbox1">
              ...
              <SortPaginationComp />
              {/* ScholWorksComp example #1 below */}
              ...
              {/* ScholWorksComp example #2 below */}
              <section className="c-scholworks">
                <div className="c-scholworks__main-column">
                  <ul className="c-scholworks__tag-list">
                    <li className="c-scholworks__tag-article">Article</li>
              ...
              {/* ScholWorksComp example #3 below */}
              <section className="c-scholworks">
                <div className="c-scholworks__main-column">
                  <ul className="c-scholworks__tag-list">
                    <li className="c-scholworks__tag-article">Article</li>
              ...
              {/* ScholWorksComp example #4 below */}
              <section className="c-scholworks">
                <div className="c-scholworks__main-column">
                  <ul className="c-scholworks__tag-list">
                    <li className="c-scholworks__tag-article">Article</li>
              ...
              {/* ScholWorksComp example #5 below */}
              <section className="c-scholworks">
                <div className="c-scholworks__main-column">
                  <ul className="c-scholworks__tag-list">
                    <li className="c-scholworks__tag-article">Article</li>
